...
def main():
    ...
    MODEL_DIR = "$MODELDIR"  # Replace with actual model directory
    AUDIO_GATE_MODEL = "path/to/your/audio_gate_model.pth"
    ...
    for item in tqdm(mix120_data):
        ...
        try:
            ...
            results['predictions'][video_id] = pred_result
            ...
            results['inference_results'][video_id] = {
                'output': result.stdout,
                'question': question,
                'confidence': pred_result['confidence'],
                'expert_gates': pred_result['expert_gates'].tolist()
            }
        ...
        if len(results['predictions']) % 10 == 0:
